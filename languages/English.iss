...
ChecksumMismatchMaintenance    =Error: Checksum mismatch%n%nFile '%1' is corrupted.%n%nThe installation cannot continue. Please try again, and if the issue persists, report it to the developers.
