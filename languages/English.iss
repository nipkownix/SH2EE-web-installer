...
WineDetected                   =Wine detected%n%nThis installation was ran in Wine.%n%nThe "d3d8" DLL has automatically been set to "native, builtin" in the Wine configuration options.%n%nFor more information, see https://wiki.winehq.org/Wine_User%27s_Guide#DLL_Overrides
