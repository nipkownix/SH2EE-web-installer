...
pt_br.WineDetected                   =Wine detectado%n%nEsta instalação foi executada no Wine.%n%nAs DLLs do Silent Hill 2: Enhanced Edition foram definidas automaticamente como "native, builtin" nas opções de configuração do Wine.%n%nPara obter mais informações, consulte https://wiki.winehq.org/Wine_User%27s_Guide#DLL_Overrides
