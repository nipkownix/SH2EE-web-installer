...
pt_br.SelectDirLabel3         =Silent Hill 2: Enhanced Edition deve ser instalado na mesma pasta do Silent Hill 2 PC. Por favor, escolha a pasta onde o Silent Hill 2 está localizado.
...
pt_br.FinishedHeadingLabel    =Instalação Completa!
...
pt_br.newWelcomeLabel5 =Clique em Continuar para continuar, ou Cancelar para fechar este Setup Tool.
...
pt_br.xidiDescription                =Fornece compatibilidade com controlas modernos.
...
pt_br.MaintenanceLabelInstall        =Instalar pacotes de melhorias que não foram instalados anteriormente ou reparar pacotes quebrados.
...
pt_br.WineDetected                   =Wine/Proton detectado%n%nEsta instalação está sendo executada no Wine/Proton.%n%nAs DLLs do Silent Hill 2: Enhanced Edition foram definidas automaticamente como "native, builtin" nas opções de configuração do Wine.%n%nPara usuário do Steam Deck/OS: Esta configuração só está ativa para o perfil atual.%nSe você adicionou este instalador como um jogo não-Steam, simplesmente mude o seu alvo de SH2EEsetup.exe para sh2pc.exe e use isso para iniciar o jogo.
...
pt_br.updateFinishedHeadingLabel     =Atualização completa!
...
pt_br.uninstallFinishedHeadingLabel  =Desinstalação completa.
...
pt_br.OutdatedSetupTool              =Erro: Versão desatualizada%n%nO SH2:EE Setup Tool deve ser atualizado para poder ser usado.%n%nAtualizar o Setup Tool?
...
pt_br.ChecksumMismatch               =Erro: Problema na verificação%n%nO arquivo '%1' está corrompido.%n%nA instalação não pode continuar. Por favor, tente novamente e, se o problema persistir, informe aos desenvolvedores.
