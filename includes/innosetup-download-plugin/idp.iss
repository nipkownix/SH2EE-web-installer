...
begin
    ...
    begin
        ...
        Left := ScaleX(0);
        Top := ScaleY(16);
        Width := IDPForm.Page.SurfaceWidth - IDPForm.TotalProgressBar.Left;
        Height := ScaleY(20);
    ...
    begin
        ...
        Left := ScaleX(0);
        Top := ScaleY(64);
        Width := IDPForm.Page.SurfaceWidth - IDPForm.FileProgressBar.Left;
        Height := ScaleY(20);
        Anchors := [akLeft, akTop, akRight];
        Min := 0;
        Max := 100;
    ...
    begin
        Parent := IDPForm.Page.Surface;
        Caption := '';
        Left := IDPForm.Page.SurfaceWidth - ScaleX(125);
        Top := ScaleY(0);
        Width := ScaleX(120);
        Height := ScaleY(14);
