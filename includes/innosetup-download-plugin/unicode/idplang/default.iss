[CustomMessages]
IDP_FormCaption           =Downloading necessary files
IDP_FormDescription       =Please wait while Setup downloads necessary files.
...
IDP_DetailsButton         =Show details
IDP_HideButton            =Hide details
